...
export function PlaceFilters({ activeBrand, activeType, activeSort, brands }: PlaceFiltersProps) {
  const t = useTranslations('places.filter');
  ...
  const typeOptions = ['all', 'handmade', 'franchise'] as const;
  const sortOptions = ['rating', 'reviews', 'newest'] as const;
